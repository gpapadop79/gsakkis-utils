...
class MultiSet(Set):
    ...
    def __len__(self):
        ...
        return sum(imap(len,self._data.itervalues()))
    ...
    def __repr__(self):
        ...
        '''
        elements = sum(self._data.itervalues(), [])
    ...
    def __iter__(self):
        ...
        '''
        return chain(*imap(iter,self._data.itervalues()))
    ...
    def _add(self,element):
        self._data.setdefault(element,[]).append(element)

    def _remove(self,element):
        lst = self._data.pop(element)
        lst.pop()
        if lst:
            self._data[element] = lst
