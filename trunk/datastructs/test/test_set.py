# almost identical with python2.4/test/test_set.py
# changed self.repr to use set.__name__ instead of hardcoding the name
...
from sortedsets import InsertionOrderedSet as set
